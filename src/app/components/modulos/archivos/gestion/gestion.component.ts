...
export class GestionComponent implements OnInit {
  ...
  public eliminar(){
    ...
    let _this:GestionComponent=this;
    swal({
          ...
          if(_this.gestion.gestionid!=="")
            _this._gestionService.delGestion(_this.gestion.gestionid)
                .subscribe(
                  success => {
                    if(success===true){
                      swal("¡Proceso eliminado!", "El proceso '"+_this.gestion.denominacion+"' ha sido eliminado de la base de datos satisfactoriamente.", "success");
